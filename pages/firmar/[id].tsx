...
export default function FirmarPage() {
  ...
  const clearCanvas = () => { const ctx = canvasRef.current!.getContext('2d')!; ctx.clearRect(0, 0, 520, 140) }
  ...
  const enviarFirma = async () => {
    ...
    try {
      ...
      setFirmado(true)
      setPdfFirmadoB64(data.pdfFirmadoBase64)
      setHashFirmado(data.hashFirmado)
  ...
  return (
    <>
      <Head>
        <title>Firmar documento — SafeContract</title>
        ...
        <div className={styles.content}>
          {firmado ? (
            <div className={styles.card} style={{ textAlign: 'center', padding: '48px 28px' }}>
              ...
              <div className={styles.successSub}>Recibiste una copia por mail. A continuación el certificado de tu firma.</div>
            ...
            <>
              <div className={styles.docHeader}>
                ...
                <div>
                  ...
                  <div className={styles.docSub}>Enviado por SGS World Legaltech</div>
                </div>
              </div>
                  ...
                  <div className={styles.imgPanel}>
                    {!imgSrc ? (
                      <div className={styles.imgUpload} onClick={() => imgInputRef.current?.click()}>
                        ...
                        <div style={{ fontSize: 12, opacity: 0.7 }}>PNG o JPG · fondo blanco o transparente</div>
                      ...
                      <div className={styles.imgPreview}>
                        ...
                        <button className={styles.btnSec} onClick={() => { setImgSrc(''); if (imgInputRef.current) imgInputRef.current.value = '' }}>Cambiar imagen</button>
                        <input ref={imgInputRef} type="file" accept="image/png,image/jpeg" style={{ display: 'none' }} onChange={loadImg} />
                      </div>
                    )}
                  </div>
              ...
              <div className={styles.card}>
                ...
                <div className={styles.row2}>
                  <div className={styles.field}>
                    ...
                    <input type="text" placeholder="Tu nombre" value={nombreFirmante} onChange={e => setNombreFirmante(e.target.value)} />
                  </div>
                  <div className={styles.field}>
                    <label className={styles.label}>DNI / CUIT</label>
                    <input type="text" placeholder="20-12345678-9" value={dni} onChange={e => setDni(e.target.value)} />
                  </div>
                </div>
              </div>
