            ...
            <>
              ...
              {verPdf && (
                <div className={styles.pdfViewerWrap}>
                  {pdfOriginalB64
                    ? <iframe src={`data:application/pdf;base64,${pdfOriginalB64}#toolbar=1&scrollbar=1&view=FitH`} style={{ width: '100%', height: 700, border: 'none', display: 'block', overflow: 'auto' }} title="Documento a firmar" />
